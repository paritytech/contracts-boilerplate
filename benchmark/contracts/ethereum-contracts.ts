        ...
        calls: [
            {
                ...
                exec: async (address) => {
                    ...
                    const data = ('0x59635f6f000000000000000000000000' +
                        tokenHex +
                        '') as `0x${string}`
                    return await env.wallet.writeContract({
                        address,
